...
import { runLedger, toTracked } from './ledger';
...
const { assets, events } = runLedger([
    { hash: 'a', ts: 1, legs: [leg('ETH', WETH, 1, 1990), leg('USDC', USDC, -2000, 2000)] },
    { hash: 'b', ts: 2, legs: [leg('ETH', WETH, 1, 3000)] },
    { hash: 'c', ts: 3, legs: [leg('ETH', WETH, -1, 3980), leg('USDC', USDC, 4000, 4000)] },
    { hash: 'd', ts: 4, legs: [leg('GHO', '0x40d16fc0246ad3160ccc09b8d0d3a2cd28ae6c2f', -300, 300), leg('cbBTC', '0xcb', 0.01, null)] },
    { hash: 'e', ts: 5, legs: [leg('RAIL', '0xra', 10, null)] }
]);
...
near(eth.avgSell, 4000);
near(eth.realizedUsd, 1500);
near(eth.unrealizedUsd!, 2500);
